...
const CoinDetailPage: React.FC = () => {
  ...
  return (
    coin&&<div className="min-h-screen  relative">
      ...
      <div className="  rounded-lg shadow-md overflow-hidden">
        {/* Header */}
        <div className="p-6 ">
          <h1 className="text-3xl font-bold mb-2">{coin.name} ({coin.ticker})</h1>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription className="flex gap-3">
                    <p>
                      <span>By: </span>
                      <span>{`${coin.owner.slice(0,4)}...${coin.owner.slice(-4)}`} </span>
                    </p>
                    <p>{formatDistanceToNow(new Date(parseInt(coin.createdAt.toString()) * 1000), { addSuffix: true })}</p>
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-2">
                <CoinInfo description={coin.description} image={coin.image} supply={coin.supply} />
                </CardContent>
              </Card>
            </TabsContent>
